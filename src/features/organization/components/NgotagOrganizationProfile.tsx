...
interface NgotagOrganizationProfileProps {
  orgId: string
  orgName: string
  ...
  return (
    <Panel className="flex items-center gap-3.5">
      ...
      <div className="min-w-0">
        <p className="font-ngotag-mono text-ngotag-strong text-[22px] leading-none font-semibold">
          {typeof value === 'number' ? value : '—'}
        </p>
        <p className="text-ngotag-muted mt-1.5 truncate text-[12.5px]">
          {label}
        </p>
      </div>
    </Panel>
...
/**
 * The unified ngotag "Organization profile" page: stats, org identity,
 ...
 */
export function NgotagOrganizationProfile({
  orgId,
  orgName,
  orgLogoUrl,
  roleLabels,
...
}: NgotagOrganizationProfileProps): React.JSX.Element {
  const roleLabel =
    roleLabels.length > 0
      ? roleLabels
    ...
    <div className="p-6" id="danger-zone-page">
      ...
      <Panel className="mt-5">
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0">
            <h2 className="font-display text-ngotag-strong truncate text-[17px] font-semibold">
              {orgName}
            </h2>
            <p className="text-ngotag-muted mt-0.5 truncate text-[13px]">
              {[
                roleLabel,
                createDateTime
      ...
      <Panel className="mt-5" id="danger-zone">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="min-w-0">
            ...
            <p className="text-ngotag-muted mt-1 max-w-[52ch] text-[13px]">
