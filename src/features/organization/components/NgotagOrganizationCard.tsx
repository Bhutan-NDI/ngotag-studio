...
/**
 * One organization card in the ngotag Organizations grid. Settings (Edit /
  ...
  return (
    <Panel>
      <div className="relative z-[4] flex flex-col gap-4">
        <div className="flex items-start justify-between gap-3">
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              <h3
                className="font-display text-ngotag-strong truncate text-[15.5px] font-semibold"
                title={org.name}
              >
                {org.name}
              </h3>
              <p className="font-ngotag-mono text-ngotag-faint mt-0.5 truncate text-[10.5px] font-medium tracking-[0.08em]">
                {roleLabel}
              </p>
            </div>
          </div>
          ...
          {isCurrent ? (
            <span
              className="border-ngotag-grid text-ngotag-accent inline-flex flex-none items-center gap-1 rounded-full border px-2.5 py-1 text-[11.5px] font-medium whitespace-nowrap"
            ...
            <button
              ...
              className="ndi-plainlink text-ngotag-accent flex-none text-[12.5px] font-medium whitespace-nowrap disabled:opacity-60"
            >
        ...
        {org.description ? (
          <p
            className="text-ngotag-muted truncate text-[13px]"
        ...
        <div className="h-px bg-[var(--ngotag-border-subtle)]" />
            ...
            <>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button
                    type="button"
                    className="ndi-plainlink text-ngotag-muted font-medium"
                  >
                    Settings
                  </button>
                </DropdownMenuTrigger>
              ...
              <span className="text-ngotag-faint">·</span>
            </>
          ) : null}
