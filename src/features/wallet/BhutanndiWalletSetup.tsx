 ...
 * non-bhutanndi WalletSetup.tsx, just the "Wallet type" (step 2) chrome
 * reskinned to match BhutanndiCreateOrganization's Panel/Stepper/radio-card
...
interface BhutanndiWalletSetupProps {
  agentType: string
...
export function BhutanndiWalletSetup({
  agentType,
  onSelectAgentType,
  dedicatedDisabled,
  interactionDisabled,
  ...
  onSkip,
  onContinue,
}: BhutanndiWalletSetupProps): React.JSX.Element {
  return (
    <div className="p-6">
      <div>
        <PageHeader
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0">
                        <h3 className="font-display text-bhutanndi-strong text-[15px] font-semibold">
                          {opt.label}
                        </h3>
                    ...
                    <ul className="text-bhutanndi-muted ml-8 list-disc space-y-1 text-[13px]">
        ...
        >
          <div className="flex justify-center">
            <div
              ...
              style={{ background: 'var(--bhutanndi-mint-12)' }}
            >
              <Icon
                name="check"
                size={28}
                strokeWidth={2.4}
                className="text-bhutanndi-accent"
              />
            </div>
          </div>

          <h2 className="font-display text-bhutanndi-strong mt-4 text-xl font-semibold">
            Wallet created successfully!
          </h2>

          <p className="text-bhutanndi-muted mt-2">
            {showSkip
