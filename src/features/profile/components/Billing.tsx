  ...
  const plans = [
    {
      ...
      features: [
        ...
        'Network Agent: Indicio [TestNet, DemoNet], Bcovrin [testnet], Ethereum [Sepolia] and Polygon [testnet]',
    ...
    },
    {
      ...
      features: [
        ...
        'Network Agent: Indicio [TestNet, DemoNet, MainNet], Bcovrin [testnet], Ethereum [MainNet] and Polygon [MainNet]',
