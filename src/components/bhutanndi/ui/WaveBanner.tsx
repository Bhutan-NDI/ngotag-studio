...
export function WaveBanner({
  ...
  return (
    <section
      ...
      className="border-bhutanndi-grid relative overflow-hidden rounded-[16px] border px-5 py-7 min-[641px]:px-7 min-[641px]:py-8"
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'var(--bhutanndi-grid-bg)',
          backgroundSize: 'var(--bhutanndi-grid-size)',
      ...
      <div className="relative z-[4] max-w-[52ch]">
        ...
        <h1 className="font-display text-bhutanndi-strong mt-3 text-[clamp(24px,3vw,30px)] leading-[1.12] font-semibold tracking-[-0.025em] [text-wrap:balance]">
          {title}
        </h1>
        <p className="text-bhutanndi-muted mt-3 text-[15px] leading-[1.6] [text-wrap:pretty]">
          {lead}
        </p>
