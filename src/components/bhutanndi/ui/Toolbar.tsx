...
export function Toolbar({
  ...
  return (
    <div className="border-bhutanndi-subtle relative z-[4] flex flex-wrap items-center gap-2.5 border-b p-4 min-[641px]:px-6">
      {left}
      {right ? (
...
export function ToolbarCount({
  ...
  return <p className="text-bhutanndi-faint m-0 text-[13px]">{children}</p>
}
