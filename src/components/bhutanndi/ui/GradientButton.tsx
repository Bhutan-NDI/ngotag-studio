 ...
 */
export const GRADIENT = 'var(--bhutanndi-grad-cta)'
  ...
  return (
    <button
      ...
      style={
        disabled
          ? {
              background: 'var(--bhutanndi-surface-raised)',
              color: 'var(--bhutanndi-text-faint)',
              border: '1px solid var(--bhutanndi-border-subtle)',
              boxShadow: 'none',
            }
          : {
              background: GRADIENT,
              color: 'var(--bhutanndi-text-on-mint)',
