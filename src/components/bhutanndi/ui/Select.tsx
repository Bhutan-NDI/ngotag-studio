...
export function Select({
  ...
  return (
    ...
    >
      ...
      >
        <span
          className={`min-w-0 flex-1 truncate text-left ${current ? '' : 'text-bhutanndi-faint'}`}
        >
        ...
        ? createPortal(
            ...
            <div
              ...
              style={{
                ...
                borderColor: 'var(--bhutanndi-border-grid)',
                background: 'var(--bhutanndi-surface-menu)',
                boxShadow:
                  '0 20px 48px rgb(var(--bhutanndi-shade) / 0.45), inset 0 1px 0 rgb(var(--bhutanndi-gloss) / 0.06)',
              }}
            >
              {options.map((o, i) => (
                <button
                ...
                >
                  <span className="min-w-0 flex-1">
                    ...
                    {o.hint ? (
                      <span className="font-bhutanndi-mono text-bhutanndi-faint mt-0.5 block truncate text-[11px]">
                        {o.hint}
                      </span>
                    ) : null}
                  </span>
                  {o.value === value ? (
                    <Icon
                      ...
                      size={15}
                      strokeWidth={2.2}
                      className="text-bhutanndi-accent flex-none"
                    />
                  ) : null}
                </button>
              ))}
