...
export function QrPlaceholder({
  ...
  if (!value) {
    return (
      <div
        className="border-bhutanndi-grid flex aspect-square w-full max-w-[260px] items-center justify-center rounded-[14px] border"
        style={{ background: 'rgb(var(--bhutanndi-tint) / 0.03)' }}
      >
        <span className="text-bhutanndi-faint flex flex-col items-center gap-2.5">
  ...
  return (
    <div
      className="border-bhutanndi-grid w-full max-w-[260px] rounded-[14px] border p-4"
