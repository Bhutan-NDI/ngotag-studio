...
ARG NEXT_PUBLIC_MARKETPLACE_OFFER_URL
ARG NEXT_PUBLIC_MARKETPLACE_REQUIRED
...
ARG NEXT_PUBLIC_ETHEREUM_TESTNET_URL
ARG NEXT_PUBLIC_ETHEREUM_MAINNET_URL
...
ENV NEXT_PUBLIC_MODE=$NEXT_PUBLIC_MODE \
    ...
    NEXT_PUBLIC_MARKETPLACE_OFFER_URL=$NEXT_PUBLIC_MARKETPLACE_OFFER_URL \
    NEXT_PUBLIC_MARKETPLACE_REQUIRED=$NEXT_PUBLIC_MARKETPLACE_REQUIRED \
    ...
    NEXT_PUBLIC_ETHEREUM_TESTNET_URL=$NEXT_PUBLIC_ETHEREUM_TESTNET_URL \
    NEXT_PUBLIC_ETHEREUM_MAINNET_URL=$NEXT_PUBLIC_ETHEREUM_MAINNET_URL \
